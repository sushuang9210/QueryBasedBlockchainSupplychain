...
def next_transaction(beefPatty,chickenPatty,bacon,buns,pickles,lettuce,cheese,ketchup,mayonnaise,potato,beef,chicken,pork,sesames,flour,cucumber,vinegar,milk,tomato,egg,sys_time):
